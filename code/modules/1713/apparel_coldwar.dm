...
/obj/item/clothing/suit/swat //these likely need upgrading to armor
	...
	worn_state = "swat"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 70, arrow = 80, gun = ARMOR_CLASS*3, energy = 40, bomb = 20, bio = 44, rad = 40)
	var/slots = 6
	ripable = FALSE
	flags = CONDUCT
...
/obj/item/clothing/suit/nbcponcho
	...
	w_class = ITEM_SIZE_TINY // It's very light.
	item_flags = AIRTIGHT
...
/* Miscallaneous*/
	...
	/* John Toughguy - Jungle Commando definitely does not rhyme with a certain movie franchise. */
