...
obj/structure/closet/crate/loottreasurechest/New()
	...
	if(rarity <= 2)
		paths = list(/obj/item/stack/ore/tin = rand(0, 2),
				...
				/obj/item/stack/money/coin/copper = rand(2, 4),
				/obj/item/stack/money/coin/silver = rand(2, 4),
		...
		paths = list(/obj/item/stack/ore/iron = rand(0, 3),
				...
				/obj/item/stack/money/coin/copper = rand(2, 4),
				/obj/item/stack/money/coin/silver = rand(2, 4),
				/obj/item/stack/money/coin/gold = rand(2, 4),
		...
		paths = list(/obj/item/stack/ore/iron = rand(0, 4),
				...
				/obj/item/stack/money/coin/copper = rand(3, 4),
				/obj/item/stack/money/coin/silver = rand(3, 4),
				/obj/item/stack/money/coin/gold = rand(3, 4),
