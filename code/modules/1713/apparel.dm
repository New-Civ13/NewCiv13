...
/obj/item/clothing/under/redbodyglove
	name = "red bodyglove"
	desc = "A tight red bodyglove worn by Red guards."
...
/obj/item/clothing/shoes/replicantshoes
	...
	armor = list(melee = 45, arrow = 70, gun = ARMOR_CLASS*2, energy = 45, bomb = 35, bio = 15, rad = FALSE)
...
/obj/item/clothing/shoes/redguardshoes
	...
	body_parts_covered = FEET
	force = WEAPON_FORCE_PAINFUL
	armor = list(melee = 55, arrow = 70, gun = ARMOR_CLASS*2, energy = 65, bomb = 35, bio = 15, rad = FALSE)
	cold_protection = FEET
	min_cold_protection_temperature = SHOE_MIN_COLD_PROTECTION_TEMPERATURE
	slowdown = 0.1
	health = 40
...
/obj/item/clothing/gloves/replicantgloves
	...
	force = WEAPON_FORCE_PAINFUL
	armor = list(melee = 45, arrow = 50, gun = ARMOR_CLASS*2, energy = 45, bomb = 35, bio = 15, rad = FALSE)
...
/obj/item/clothing/gloves/veryblack
	name = "very black gloves"
	desc = "A pair of void black gloves."
	icon_state = "veryblack"
	item_state = "veryblack"
	worn_state = "veryblack"
	body_parts_covered = HANDS
	force = WEAPON_FORCE_PAINFUL
	armor = list(melee = 10, arrow = 5, gun = ARMOR_CLASS, energy = 2, bomb = 5, bio = 5, rad = FALSE)
	cold_protection = HANDS
	min_cold_protection_temperature = SHOE_MIN_COLD_PROTECTION_TEMPERATURE
	health = 40
...
/obj/item/clothing/suit/armor/replicant
	...
	armor = list(melee = 45, arrow = 90, gun = ARMOR_CLASS*3, energy = 55, bomb = 60, bio = 20, rad = FALSE)
	value = 50
	slowdown = 1.5
	health = 60
...
/obj/item/clothing/suit/armor/redguard
	...
	desc = "A thick, extremely expensive plastoid armor with a crimson red robe attached."
	icon_state = "redguard"
	item_state = "redguard"
	worn_state = "redguard"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 75, arrow = 90, gun = ARMOR_CLASS*3, energy = 75, bomb = 100, bio = 20, rad = FALSE)
	value = 70
	slowdown = 0.9
	health = 60
...
/obj/item/clothing/suit/armor/senateguard
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 75, arrow = 90, gun = ARMOR_CLASS*4, energy = 75, bomb = 100, bio = 20, rad = FALSE)
	value = 70
	slowdown = 0.9
	health = 60
...
/obj/item/clothing/suit/armor/replicant/pilot
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 25, arrow = 50, gun = ARMOR_CLASS*3, energy = 40, bomb = 50, bio = 20, rad = FALSE)
	value = 50
	slowdown = 1.5
	health = 60
...
/obj/item/clothing/suit/armor/replicant/sgt
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 45, arrow = 90, gun = ARMOR_CLASS*3, energy = 45, bomb = 60, bio = 20, rad = FALSE)
	value = 50
	slowdown = 1.5
	health = 60
...
/obj/item/clothing/suit/armor/replicant/reinforced
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 45, arrow = 90, gun = ARMOR_CLASS*3, energy = 47, bomb = 80, bio = 20, rad = FALSE)
	value = 50
	slowdown = 1.5
	health = 60
...
/obj/item/clothing/suit/armor/replicant/commando
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 55, arrow = 95, gun = ARMOR_CLASS*4, energy = 55, bomb = 60, bio = 10, rad = FALSE)
	value = 50
	slowdown = 1.5
	health = 60
...
/obj/item/clothing/suit/armor/replicant/commander
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 55, arrow = 95, gun = ARMOR_CLASS*4, energy = 45, bomb = 60, bio = 20, rad = FALSE)
	value = 50
	slowdown = 1.5
	health = 60
...
/obj/item/clothing/suit/armor/stormtrooper
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 45, arrow = 96, gun = ARMOR_CLASS*4, energy = 50, bomb = 50, bio = 20, rad = FALSE)
	value = 50
	slowdown = 1.5
	health = 75
...
/obj/item/clothing/suit/armor/stormsurgeon
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 45, arrow = 86, gun = ARMOR_CLASS*3, energy = 40, bomb = 40, bio = 20, rad = FALSE)
	value = 50
	slowdown = 1.2
	health = 75
...
/obj/item/clothing/suit/armor/stormradio
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 35, arrow = 66, gun = ARMOR_CLASS*3, energy = 35, bomb = 25, bio = 20, rad = FALSE)
	value = 50
	slowdown = 0.85
	health = 57
...
/obj/item/clothing/head/helmet/redguard
	...
	desc = "A reinforced plastoid helmet of the Extra-Galactic Empire's Red Guards."
	icon_state = "redguard"
	item_state = "redguard"
	worn_state = "redguard"
