...
/obj/item/weapon/armorplates
	...
	var/protection = ARMOR_CLASS*0.5 // Used in armor calculation. Adds+10 protection.
...
/obj/item/clothing/accessory/armor/knee_protections
	...
	armor = list(melee = 75, arrow = 50, gun = ARMOR_CLASS*2, energy = 25, bomb = 55, bio = 20, rad = FALSE)
	slowdown = 0.1
	sharp = FALSE
	edge = TRUE
	w_class = ITEM_SIZE_SMALL
...
/obj/item/clothing/accessory/armor/legguards
	...
	attack_verb = list("bashed", "bludgeoned", "whacked")
	body_parts_covered = LEGS
	armor = list(melee = 75, arrow = 50, gun = ARMOR_CLASS*2, energy = 32, bomb = 55, bio = 20, rad = FALSE)
	slowdown = 0.3
	sharp = FALSE
	edge = TRUE
	w_class = ITEM_SIZE_SMALL
...
/obj/item/clothing/accessory/armor/elbow_protections
	...
	armor = list(melee = 65, arrow = 45, gun = ARMOR_CLASS*2, energy = 25, bomb = 55, bio = 20, rad = FALSE)
	slowdown = 0.1
	sharp = FALSE
	edge = TRUE
	w_class = ITEM_SIZE_SMALL
...
/obj/item/clothing/accessory/armor/coldwar/plates/interceptor // Usually the BA is made with kevlar...
	name = "black Interceptor body-armor"
	desc = "Some wearable body-armor designed to offer solid protection. It can stop even some rifle rounds when equipped with additional plates."
	icon_state = "iba_black"
	item_state = "iba_black"
	worn_state = "iba_black"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 75, arrow = 100, gun = ARMOR_CLASS*2, energy = 25, bomb = 65, bio = 20, rad = FALSE) // Stops pistols unless fitted with 2 plates (+10 protection per plate), moves it to level 3 (stops rifle bullets.)
	value = 120
	slowdown = 0.4
...
/obj/item/clothing/accessory/armor/coldwar/plates/interceptor/ucp
	...
	desc = "Some wearable body-armor designed to offer solid protection. It can stop even some rifle rounds when equipped with additional plates. This one has the Universal Camouflage Pattern."
	icon_state = "iba_ucp"
	item_state = "iba_ucp"
	worn_state = "iba_ucp"
...
/obj/item/clothing/accessory/armor/coldwar/plates/interceptor/ocp
	...
	desc = "Some wearable body-armor designed to offer solid protection. It can stop even some rifle rounds when equipped with additional plates. This one has the Operational Camouflage Pattern."
	icon_state = "iba_ocp"
	item_state = "iba_ocp"
	worn_state = "iba_ocp"
...
/obj/item/clothing/accessory/armor/coldwar/plates/platecarrier
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 30, arrow = 20, gun = ARMOR_CLASS*2, energy = 20, bomb = 30, bio = 20, rad = FALSE)
	value = 130
	slowdown = 0.1
	w_class = ITEM_SIZE_LARGE
	weight = 1.0
...
/obj/item/clothing/accessory/armor/nomads/thickcarrier
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 30, arrow = 30, gun = ARMOR_CLASS*2, energy = 16, bomb = 30, bio = 15, rad = FALSE)
	value = 90
	slowdown = 0.10
...
/obj/item/clothing/accessory/armor/coldwar/plates/platecarrier_ukraine
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 40, arrow = 20, gun = ARMOR_CLASS*2, energy = 20, bomb = 30, bio = 20, rad = FALSE)
	value = 130
	slowdown = 0.1
	w_class = ITEM_SIZE_LARGE
	weight = 1.0
...
/obj/item/clothing/accessory/armor/coldwar/plates/b45/ext
	...
	item_state = "6b45_ext"
	worn_state = "6b45_ext"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS // Covers legs && arms. Hence "extended".
	armor = list(melee = 70, arrow = 95, gun = ARMOR_CLASS*3, energy = 22, bomb = 65, bio = 20, rad = FALSE)
	value = 130
	slowdown = 0.4
	w_class = ITEM_SIZE_LARGE
	weight = 4.2
...
/obj/item/clothing/accessory/armor/coldwar/plates/b46
	...
	armor = list(melee = 60, arrow = 95, gun = ARMOR_CLASS*2, energy = 22, bomb = 55, bio = 20, rad = FALSE)
	value = 150
	slowdown = 0.1
	w_class = ITEM_SIZE_LARGE
	weight = 3.2
...
/obj/item/clothing/accessory/armor/coldwar/pasgt
	...
	worn_state = "pasgt_woodland"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 67, arrow = 95, gun = ARMOR_CLASS*2, energy = 22, bomb = 60, bio = 20, rad = FALSE) // PASGT not interceptor. So ARMOR_CLASS*2 (stops pistols)
	value = 90
	slowdown = 0.3
	w_class = ITEM_SIZE_LARGE
	weight = 3.8
...
/obj/item/clothing/accessory/armor/coldwar/rb23
	...
	armor = list(melee = 70, arrow = 95, gun = ARMOR_CLASS*3, energy = 30, bomb = 70, bio = 20, rad = FALSE)
	slowdown = 0.1
	weight = 4.8
...
/obj/item/clothing/gloves/fingerless/army
	...
	slot_flags = SLOT_GLOVES
	fingerprint_chance = 100
	armor = list(melee = 25, arrow = 25, gun = ARMOR_CLASS, energy = 22, bomb = 45, bio = 20, rad = 5)
...
/obj/item/clothing/accessory/armor/nomads/kevlarblack
	...
	armor = list(melee = 80, arrow = 95, gun = ARMOR_CLASS*2, energy = 35, bomb = 64, bio = 20, rad = FALSE)
	value = 90
	slowdown = 0.4
	w_class = ITEM_SIZE_LARGE
	weight = 3.8
...
/obj/item/clothing/accessory/armor/nomads/civiliankevlar
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 60, arrow = 90, gun = ARMOR_CLASS*2, energy = 22, bomb = 60, bio = 20, rad = FALSE)
	value = 90
	slowdown = 0.30
	w_class = ITEM_SIZE_LARGE
	weight = 3.6
...
/obj/item/clothing/head/helmet/motorcycle
	...
	armor = list(melee = 55, arrow = 65, gun = ARMOR_CLASS, energy = 35, bomb = 35, bio = 30, rad = FALSE)
...
/obj/item/clothing/suit/storage/jacket/punk
	...
	armor = list(melee = 15, arrow = FALSE, gun = FALSE, energy = 15, bomb = 5, bio = 30, rad = 30)
...
/obj/item/clothing/accessory/armor/nomads/baily //too broad, can't make out what detail this is actually meant to be associated with.
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS|LEGS
	armor = list(melee = 40, arrow = 95, gun = ARMOR_CLASS*3, energy = 30, bomb = 35, bio = 20, rad = FALSE)
	value = 90
	slowdown = 0.2
	w_class = ITEM_SIZE_NORMAL
	weight = 2
...
/obj/item/clothing/suit/armor/zgz1
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
	armor = list(melee = 45, arrow = 90, gun = ARMOR_CLASS*3, energy = 50, bomb = 60, bio = 20, rad = FALSE)
	value = 50
	slowdown = 0.5
	health = 60
...
/obj/item/clothing/accessory/armor/nomads/iogsuit //too broad, this is meant to be some sort of extreme sports armorwear or something.
	...
	worn_state = "iogsuit"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS|LEGS
	armor = list(melee = 110, arrow = 100, gun = ARMOR_CLASS*4, energy = 50, bomb = 90, bio = 100, rad = FALSE)
	value = 160
	slowdown = 0.2
	w_class = ITEM_SIZE_LARGE
	weight = 3.4
...
/obj/item/clothing/suit/armor/mechanical
	...
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 85, arrow = 150, gun = ARMOR_CLASS*4, energy = 55, bomb = 70, bio = 30, rad = FALSE)
	value = 150
	slowdown = 1.8
	health = 175
